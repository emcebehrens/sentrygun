...
public:   
    ...
    PanTiltManagerThread(unsigned char tiltChannelNumber,
    ...
    void activatePositionFeedback();
    void deactivatePositionFeedback();
    void getTiltPosition();
    void getPanPosition();
...
private:
    ...
    unsigned char tiltChanNr_;
    unsigned char panChanNr_;
    unsigned short tiltHome_;
    unsigned short panHome_;
    bool threadActive_;
    QString serialPortName_;
    unsigned short targetVal_;
    bool givePositionFeedback_;
