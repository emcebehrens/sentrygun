...
void TrackingThread::run()
{
    ...
    while(1) {
        ...
        //capVideo.open("c:\\gtdev\\software\\turret_development\\examples\\objectTracking\\blobs\\768x576.avi");

        capVideo.open(0);  //open capture object at location zero (default location for webcam)
        //set height and width of capture frame
        ...
        //while(capVideo.get(CV_CAP_PROP_POS_FRAMES) < capVideo.get(CV_CAP_PROP_FRAME_COUNT)-1){
